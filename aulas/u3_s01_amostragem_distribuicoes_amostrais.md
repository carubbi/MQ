...
- **Tópicos:** População; Amostra; Amostragem; Representatividade; Amostragem aleatória simples; Amostragem estratificada; Distribuição amostral; Teorema central do limite; Erro-padrão; Tamanho amostral
- **Resultado de aprendizagem:** selecionar e comparar amostras e interpretar distribuições amostrais, Teorema Central do Limite e erro-padrão.
