...
- **Tópicos:** Distribuição binomial; Distribuição de Poisson; Esperança; Variância
- **Resultado de aprendizagem:** selecionar, calcular e simular modelos Binomial e Poisson, justificando mecanismos, parâmetros e pressupostos.
