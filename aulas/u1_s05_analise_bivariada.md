...
- **Tópicos:** Tabela de contingência; Associação; Covariância; Correlação linear; Gráfico; Valor discrepante
- **Resultado de aprendizagem:** analisar relações entre duas variáveis por tabelas, percentuais condicionais, dispersão e correlação, sem confundir associação com causalidade.
