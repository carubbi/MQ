...
- **Período das aulas da disciplina:** 7 de agosto a 4 de dezembro de 2026.
...
- **Organização pedagógica:** neste semestre, os dois blocos consecutivos
  ...
  computacional, acompanhamentos ou avaliações nas aulas previstas pelos
...
#### Semana 1 — Fundamentos estatísticos e introdução ao pandas — 07/08

- **Conteúdo formal:** 01.01.
- **Aula 1 — 15h30 às 17h10:** apresentação da disciplina; critérios de avaliação; ambientação no Google Colab e em Python; introdução ao pandas e manipulações básicas de dados.
...
- **Atividade e evidência da Aula 1:** preencher e executar integralmente o notebook, com identificação da fonte, das observações, das variáveis e da unidade de análise. Todo o código será produzido em células inicialmente em branco, orientadas por comentários.
- **Atividade e evidência da Aula 2:** formular uma pergunta estatística; identificar população, amostra, unidade de análise e alcance das conclusões.
- **Recursos:**
  - **Material da Aula 1:** [Ambientação computacional e estrutura dos dados](../aulas/u1_a01_ambientacao_dados.md).
  - **Material da Aula 2:** [Fundamentos estatísticos e investigação com dados](../aulas/u1_a02_fundamentos_investigacao_dados.md).
  - **Notebook guiado da Aula 1:** [Ambientação computacional e estrutura dos dados](../notebooks/u1_a01_ambientacao_dados.ipynb).
  - **Notebook guiado da Aula 2:** [Fundamentos estatísticos e investigação com dados](../notebooks/u1_a02_fundamentos_investigacao_dados.ipynb).

#### Semana 2 — Prorrogação do Dia do Estudante — 14/08

- **Ocorrência institucional:** feriado.
- **Aulas 3 e 4:** sem aula.
...
- **Recursos:**
  - **Material da Aula 5:** [Tipos, qualidade e pré-processamento básico](../aulas/u1_a05_tipos_qualidade_preprocessamento.md).
  - **Notebook guiado da Aula 5:** [Tipos, qualidade e pré-processamento básico](../notebooks/u1_a05_tipos_qualidade_preprocessamento.ipynb).
  - **Material da Aula 6:** [Distribuições de frequências e visualização de dados](../aulas/u1_a06_frequencias_representacao.md).
  - **Notebook guiado da Aula 6:** [Distribuições de frequências e visualização de dados](../notebooks/u1_a06_frequencias_representacao.ipynb).
...
- **Unidade I:** 24 horas-aula institucionais; 20 ministradas e 4 referentes ao feriado de 14/08.
- **Unidade II:** 24 horas-aula ministradas.
- **Unidade III:** 24 horas-aula institucionais; 20 ministradas e 4 referentes ao feriado de 20/11.
- **Total:** 72 horas-aula institucionais; 64 ministradas e 8 correspondentes a feriados sem aula.
...
- **Orientação:** as sessões são extraordinárias, não substituem aulas regulares e não alteram a carga horária. O local será divulgado no AVA/Moodle. Em caso de convocação para mais de uma disciplina no mesmo horário, o estudante deverá comunicar a situação ao docente.
