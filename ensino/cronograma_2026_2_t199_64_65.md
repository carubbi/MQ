...
- **Organização pedagógica:** neste semestre, os dois blocos consecutivos
  ...
  organizados em tópicos em sequência pedagógica, com conceitos no material de
  aula e aplicações nos notebooks, sem associação rígida entre
...
- **Trabalhos:** consulte os [enunciados e orientações das APs](../trabalhos/README.md), as [rubricas](../trabalhos/rubricas.md) e os [modelos de notebooks](../trabalhos/modelos-notebooks.md).
...
- **Atividade e evidência da Aula 1:** preencher e executar integralmente o notebook, com identificação da fonte, das observações, das variáveis e da unidade de análise.
...
- **Recursos:**
  - **Notebook integral da Aula 1:** [Ambientação computacional](../notebooks/u1_a01.ipynb).
  - **Notebook integral da Aula 2:** [Fundamentos da Estatística](../notebooks/u1_a02.ipynb).
...
- **Recursos:**
  - **Notebook integral da Aula 5:** [Tipos de dados e pré-processamento básico](../notebooks/u1_a05.ipynb).
  - **Notebook integral da Aula 6:** [Distribuições de frequências e visualização de dados](../notebooks/u1_a06.ipynb).
...
- **Aula 8 — 17h20 às 19h:** assimetria com apoio gráfico e cálculo por biblioteca; curtose como complemento breve, com exemplo pronto; identificação de valores discrepantes por espécie; retomada breve de histogramas, robustez e boxplot.
...
- **Recursos:**
  - **Notebook integral da Aula 7:** [Medidas de posição e dispersão](../notebooks/u1_a07.ipynb).
  - **Notebook integral da Aula 8:** [Forma e interpretação das distribuições](../notebooks/u1_a08.ipynb).
...
- **Recursos:**
  - **Notebook integral da Aula 9:** [Associação entre Variáveis Qualitativas](../notebooks/u1_a09.ipynb).
  - **Notebook integral da Aula 10:** [Associação entre Variáveis Quantitativas](../notebooks/u1_a10.ipynb).
...
- **Entrega da AP1:** [enunciado e requisitos](../trabalhos/ap1.md); link do repositório pelo AVA até 23h59.
...
- **Recursos:**
  - **Material de revisão:** em construção.
...
- **Entrega da AP2:** [enunciado e requisitos](../trabalhos/ap2.md); link do mesmo repositório pelo AVA até 23h59.
...
- **Entrega da AP3:** [enunciado e requisitos](../trabalhos/ap3.md); link do mesmo repositório pelo AVA até 23h59.
